...
namespace Zuh.Compiler.Tests.Parsing.Expressions {
    public class UnionExpressionTests {
        ...
        public class Parse_InvalidUnionExpression_Fails_Data : TheoryData<string> {
            public Parse_InvalidUnionExpression_Fails_Data()
        ...
        [Theory]
        [ClassData(typeof(Parse_InvalidUnionExpression_Fails_Data))]
